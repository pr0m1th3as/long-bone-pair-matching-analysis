...
## of pair-matched Tibia skeletal samples elements
pkg load csg-toolkit
Header = longbone_Measurements;

## Load matched and mismatched Tibia data
load ("Tibia-Data.mat");
T_pairs = T_match(:,1:2);
T_match(:,1:2) = [];
T_mismatch(:,1:2) = [];
...
cases_m = size (T_match, 1);
cases_mm = size (T_mismatch, 1);

## Compute mean and standard deviation for each measurement diff
Tibia_mu = mean (T_match, 1);
Tibia_sd = std (T_match, 1);
Tibia_lb = Tibia_sd;
Tibia_ub = Tibia_sd;
...
x_limits = [-1, 1] .* [30; 20; 15; 15; 15; 15];
y_limit1 = [0, 1] .* [35; 35; 35; 35; 35; 35];
y_limit2 = [0, 1] .* [70000; 40000; 40000; 40000; 40000; 40000];

for v = 1:numel (varNames)
  ## Get column index in data
  varID = find (strcmpi (Header, varNames{v}));
  ## Compute histogram bins
  [ne_var_m, bc_var_m] = hist (T_match(:,varID), bins(:,varID)');
  [ne_var_mm, bc_var_mm] = hist (T_mismatch(:,varID), bins(:,varID)');
  ...
  Tibia_lb(varID) = lb_var;
  Tibia_ub(varID) = ub_var;
...
print (h1, "Tibia_fig1-MaxD_Per.png");
close h1
...
x_limits = [-1, 1] .* [250; 150; 150; 150; 150];
y_limit1 = [0, 1] .* [35; 35; 35; 35; 35];
y_limit2 = [0, 1] .* [50000; 50000; 50000; 50000; 50000];
...
x_limits = [-1, 1] .* [0.15; 0.15; 0.15; 0.15; 0.1];
...
## save plot as an image
print (h1, "Tibia_fig3-ArPerIndex.png");
close h1
...
x_limits = [-1, 1] .* [45000; 20000; 15000; 15000; 15000];
...
x_limits = [-1, 1] .* [40000; 15000; 15000; 15000; 15000];
y_limit1 = [0, 1] .* [40; 40; 40; 40; 40];
y_limit2 = [0, 1] .* [30000; 30000; 30000; 30000; 30000];
...
x_limits = [-1, 1] .* [20000; 10000; 10000; 10000; 10000];
y_limit1 = [0, 1] .* [40; 40; 40; 40; 40];
y_limit2 = [0, 1] .* [15000; 15000; 15000; 15000; 15000];
...
x_limits = [-1, 1] .* [1.5; 1.5; 1.5; 1; 0.5];
y_limit1 = [0, 1] .* [40; 40; 40; 40; 40];
...
x_limits = [-1, 1] .* [30000; 10000; 10000; 10000; 10000];
y_limit1 = [0, 1] .* [35; 35; 35; 35; 35];
y_limit2 = [0, 1] .* [35000; 35000; 35000; 35000; 35000];
...
x_limits = [-1, 1] .* [50000; 20000; 20000; 20000; 20000];
y_limit1 = [0, 1] .* [40; 40; 40; 40; 40];
...
x_limits = [-1, 1] .* [1.5; 1.5; 1.5; 1.5; 1.5];
y_limit1 = [0, 1] .* [30; 30; 30; 30; 30];
y_limit2 = [0, 1] .* [5000; 5000; 5000; 5000; 5000];
...
## save plot as an image
print (h1, "Tibia_fig10-Imax_Imin.png");
close h1
...
## save plot as an image
print (h1, "Tibia_fig11-theta.png");
close h1
...
## save plot as an image
print (h1, "Tibia_fig12-dihedral.png");
close h1


## Append descriptives for pair matching into 'descriptives_pair.mat'
filename = fullfile (pwd, 'private', 'descriptives_pair.mat');
Tvars = [Tibia_mu; Tibia_sd; Tibia_lb; Tibia_ub; Tibia_id];
save ('-append', '-binary', filename, 'Tvars');
clear
