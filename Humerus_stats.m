...
## of pair-matched Humerus skeletal samples
pkg load csg-toolkit
Header = longbone_Measurements;

## Load matched and mismatched Humerus data
...
cases_m = size (H_match, 1);
cases_mm = size (H_mismatch, 1);

## Compute mean and standard deviation for each measurement diff
Humerus_mu = mean (H_match, 1);
Humerus_sd = std (H_match, 1);
Humerus_lb = Humerus_sd;
...
x_limits = [-1, 1] .* [35; 20; 20; 15; 15; 15];
y_limit1 = [0, 1] .* [35; 35; 35; 35; 35; 35];
y_limit2 = [0, 1] .* [50000; 35000; 35000; 35000; 35000; 35000];

for v = 1:numel (varNames)
  ## Get column index in data
  varID = find (strcmpi (Header, varNames{v}));
  ## Compute histogram bins
  [ne_var_m, bc_var_m] = hist (H_match(:,varID), bins(:,varID)');
  [ne_var_mm, bc_var_mm] = hist (H_mismatch(:,varID), bins(:,varID)');
  ...
  Humerus_lb(varID) = lb_var;
  Humerus_ub(varID) = ub_var;
...
print (h1, "Humerus_fig1-MaxD_Per.png");
close h1
...
x_limits = [-1, 1] .* [180; 150; 120; 100; 120];
...
## save plot as an image
print (h1, "Humerus_fig2-Area.png");
close h1
...
x_limits = [-1, 1] .* [0.15; 0.15; 0.15; 0.15; 0.2];
...
## save plot as an image
print (h1, "Humerus_fig3-ArPerIndex.png");
close h1
...
x_limits = [-1, 1] .* [15000; 10000; 7500; 7500; 7500];
y_limit1 = [0, 1] .* [40; 40; 40; 40; 40];
y_limit2 = [0, 1] .* [25000; 25000; 25000; 25000; 25000];
...
x_limits = [-1, 1] .* [15000; 10000; 7500; 7500; 10000];
y_limit1 = [0, 1] .* [30; 30; 30; 30; 30];
y_limit2 = [0, 1] .* [20000; 20000; 20000; 20000; 20000];
...
x_limits = [-1, 1] .* [6000; 4000; 4000; 4000; 4000];
y_limit1 = [0, 1] .* [40; 40; 40; 40; 40];
...
## save plot as an image
print (h1, "Humerus_fig7-Ix_Iy.png");
close h1
...
x_limits = [-1, 1] .* [15000; 10000; 6000; 6000; 6000];
y_limit1 = [0, 1] .* [35; 35; 35; 35; 35];
y_limit2 = [0, 1] .* [25000; 25000; 25000; 25000; 25000];
...
## save plot as an image
print (h1, "Humerus_fig8-Imin.png");
close h1
...
x_limits = [-1, 1] .* [15000; 12000; 10000; 6000; 10000];
y_limit1 = [0, 1] .* [40; 40; 40; 40; 40];
y_limit2 = [0, 1] .* [25000; 25000; 25000; 25000; 25000];
...
## save plot as an image
print (h1, "Humerus_fig9-Imax.png");
close h1
...
## save plot as an image
print (h1, "Humerus_fig10-Imax_Imin.png");
close h1
...
## save plot as an image
print (h1, "Humerus_fig11-theta.png");
close h1
...
## save plot as an image
print (h1, "Humerus_fig12-dihedral.png");
close h1


## Append descriptives for pair matching into 'descriptives_pair.mat'
filename = fullfile (pwd, 'private', 'descriptives_pair.mat');
Hvars = [Humerus_mu; Humerus_sd; Humerus_lb; Humerus_ub; Humerus_id];
save ('-append', '-binary', filename, 'Hvars');
clear
